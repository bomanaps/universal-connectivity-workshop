#!/usr/bin/env python3
"""
Check script for Lesson 2: TCP Transport (Nim)
Validates that the student's nim-libp2p solution can connect and handle connections.
"""
import os
import re
import sys
...
def main():
    """Main check function"""
    print("ℹ Checking Lesson 2: TCP Transport (Nim)")
    print("ℹ " + "=" * 50)
