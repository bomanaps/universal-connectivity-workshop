 ...
 * Extends the ping application to support both TCP and QUIC transports.
 *
 * This lesson builds on Lesson 3 by adding:
 * - QUIC transport for modern, secure connectivity
 * - Multi-transport support (TCP + QUIC)
 * - Transport-aware connection handling
 *
 * QUIC advantages over TCP:
 * - Built-in encryption (no separate TLS handshake needed)
...
int main(int argc, char** argv) {
    ...
    auto log = libp2p::log::createLogger("Lesson4");
    ...
    // The default injector already includes both TCP and QUIC transports
    ...
    // Start host and set up transports
